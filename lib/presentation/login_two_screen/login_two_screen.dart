...
class LoginTwoScreen extends StatelessWidget {
  ...
  Widget _buildPassword(BuildContext context) {
    return BlocSelector<LoginTwoBloc, LoginTwoState, TextEditingController?>(
      ...
      child: BlocBuilder<LoginTwoBloc, LoginTwoState>(
        builder: (context, state) {
          return CustomTextFormField(
            ...
            suffix: InkWell(
              onTap: () {
                context.read<LoginTwoBloc>().add(ChangePasswordVisibilityEvent(
      ...
      child: BlocBuilder<LoginTwoBloc, LoginTwoState>(
        builder: (context, state) {
          return CustomTextFormField(
            ...
            suffix: InkWell(
              onTap: () {
                context.read<LoginTwoBloc>().add(ChangePasswordVisibilityEvent1(

import 'bloc/destination_seventeen_bloc.dart';
import 'models/destination_seventeen_model.dart';
...
class DestinationSeventeenScreen extends StatelessWidget {
  const DestinationSeventeenScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<DestinationSeventeenBloc>(
        create: (context) => DestinationSeventeenBloc(DestinationSeventeenState(
            destinationSeventeenModelObj: DestinationSeventeenModel()))
          ..add(DestinationSeventeenInitialEvent()),
        child: DestinationSeventeenScreen());
  }
  ...
  Widget _buildSeventyTwo(BuildContext context) {
    return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          BlocSelector<DestinationSeventeenBloc, DestinationSeventeenState,
                  DestinationSeventeenModel?>(
              selector: (state) => state.destinationSeventeenModelObj,
              builder: (context, destinationSeventeenModelObj) {
                return CustomDropDown(
                    ...
                    items: destinationSeventeenModelObj?.dropdownItemList ?? [],
                    prefix: Container(
          ...
          BlocSelector<DestinationSeventeenBloc, DestinationSeventeenState,
              ...
              builder: (context, destinationSeventeenModelObj) {
                return CustomDropDown(
                    ...
                    items:
                        destinationSeventeenModelObj?.dropdownItemList1 ?? [],
                    prefix: Container(
                        margin: EdgeInsets.fromLTRB(12.h, 12.v, 6.h, 12.v),
                        child: CustomImageView(

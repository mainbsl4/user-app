import 'bloc/destination_eighteen_bloc.dart';
import 'models/destination_eighteen_model.dart';
...
class DestinationEighteenPage extends StatefulWidget {
  const DestinationEighteenPage({Key? key})
      : super(
          key: key,
        );

  @override
  DestinationEighteenPageState createState() => DestinationEighteenPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<DestinationEighteenBloc>(
      create: (context) => DestinationEighteenBloc(DestinationEighteenState(
        destinationEighteenModelObj: DestinationEighteenModel(),
      ))
        ..add(DestinationEighteenInitialEvent()),
      child: DestinationEighteenPage(),
    );
  }
}

class DestinationEighteenPageState extends State<DestinationEighteenPage>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<DestinationEighteenPage> {
  late TabController group144Controller;

  @override
  void initState() {
    super.initState();
    group144Controller = TabController(length: 2, vsync: this);
  }
                            ...
                            Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  BlocSelector<DestinationEighteenBloc,
                                      DestinationEighteenState, bool?>(
                    ...
                    child: SizedBox(
                      ...
                      child: Stack(
                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: BlocSelector<
                                      DestinationEighteenBloc,
                                      DestinationEighteenState,
                                      TextEditingController?>(
                                    selector: (state) =>
                                        state.group148Controller,
                                    builder: (context, group148Controller) {
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child: BlocSelector<DestinationEighteenBloc,
                                DestinationEighteenState, String?>(

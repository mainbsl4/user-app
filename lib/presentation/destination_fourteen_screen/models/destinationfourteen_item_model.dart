...
/// This class is used in the [destinationfourteen_item_widget] screen.
class DestinationfourteenItemModel extends Equatable {
  ...
  DestinationfourteenItemModel copyWith({
    String? circleImage,
    bool? isSelectedSwitch,
    String? fortyNine,
    String? shamim,
    ...
    return DestinationfourteenItemModel(

...
class OtpDraweritem extends StatelessWidget {
  const OtpDraweritem({Key? key})
      : super(
          key: key,
        );
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgPersonBlack24dp,
                    height: 25.adaptSize,
                    width: 25.adaptSize,
                  ),
                  Padding(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgPasswordCode1,
                    height: 18.adaptSize,
                    width: 18.adaptSize,
